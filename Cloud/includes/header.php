        ...
        <ul class="navbar-nav mr-auto">
          <?php 
              if(!isset($_SESSION['email'])){
                ...
                <li class='nav-item'><a href='committeeLogin.php' class='nav-link' style='border-radius: 10em;'>Committee</a>
                ";
              }
              else{
                echo "<li class='nav-item'><a href='indemnityLetter.php' class='nav-link' style='border-radius: 10em;'>Intership Submission</a></li>";
