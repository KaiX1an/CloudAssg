...
<?php
	...
	if(isset($_POST['update_password'])){
		...
		$sqlPass = "SELECT * FROM committee WHERE password = '$current_password' AND email = '$committeeEmail'";
		...
		if($confirm_password != $new_password){
			...
			$updatePassword = "UPDATE committee SET password = '$new_password' WHERE email = '$committeeEmail'";
