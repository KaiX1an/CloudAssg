    ...
    <body>
        ...
        <?php 
            ...
            if(isset($_POST['submit_indemnity'])) {
                ...
                $insertInternship = "INSERT INTO internship (internshipID, companyName, location, startDate, endDate, status, studentID) VALUES ('$id', '$company_name','$location','$start_date', '$end_date', 'Pending Approval', '$fk_id')";
 ...
 */
                ...
                if ($uploadOk == 0){
                    ...
                    if ($num_rowsExist > 0) {
                        ...
                        VALUES 
                        ('$id', '$uploadMainTo', '$uploadSecondTo', '$uploadThirdTo', 'Pending Approval', '$fk_id')";
                    }
                    ...
                    $sel_intern = "SELECT * FROM internship WHERE internshipID = '$id'";
