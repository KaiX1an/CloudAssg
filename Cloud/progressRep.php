...
<?php 
    ...
    if(isset($_POST['submit_progress'])) {
        ...
        if ($uploadOk == 0){
            ...
            $insertProgress = "INSERT INTO progressreport (progressID, progressReport, marks, status, submissionDate, studentID) VALUES ('$id', '$target_file','0','Pending', '$datetoday', '$fk_id')";
